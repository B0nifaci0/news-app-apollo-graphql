...
import { Container, Header, Tab, Tabs, TabHeading, Icon, Text, Left, Body, Title, Thumbnail, Right, Input, Item } from 'native-base';
    ...
    return (
      ...
      <ApolloProvider client={client}>
        <Container>
          <Header hasTabs>
            <Body>
              <Thumbnail center source={{ uri: 'https://g3p3p2d4.stackpathcdn.com/wp-content/uploads/2018/08/RF_logo_H_250x40_01.png' }} style={{ height: 1, width: 380, flex: 1 }} />
            </Body>
            <Right />
          </Header>
          <Tabs locked>
